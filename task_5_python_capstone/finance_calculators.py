...
while True:
    ...
    if calc.lower() == "investment":
        ...
        while True:
            try:
                time = float(input("\nHow many years will the investment be for?\n"))
                break
            except:
                print("\nInput error.\n")
        ...
        while True:
            ...
            if interest.lower() == "simple":
                annuity = deposit * (1 + rate * time)
                print(f"\nThe value of your investment is {round(annuity,2)}\n")
                break
    ...
    # If select bond
        ...
        while True:
            try:
                n = float(input("\nHow many months until the bond is repaid?\n"))
                break
            except:
                print("\nInput error.\n")
        ...
        print(f"\nThe value of the monthly repayment is {round(repayment,2)}\n")
        break
